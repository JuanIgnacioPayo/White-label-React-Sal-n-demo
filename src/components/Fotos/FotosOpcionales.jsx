...
export default function Fotosopcionales() {
  ...
  let [inputValue27, setInputValue27] = useState("");
  let [inputValue28, setInputValue28] = useState("");
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      if (snapshot.exists()) {
        ...
        setInputValue27(targetObject.foto27);
        setInputValue28(targetObject.foto28);
  ...
  const opcionalesImagenes = [inputValue18, inputValue19, inputValue20, inputValue21, inputValue22, inputValue23, inputValue24, inputValue25, inputValue26, inputValue27, inputValue28];
  const data = [

    {
      image: opcionalesImagenes
  ...
  return (
    <Section id="servicios">
      <SEO
        title={`Fotos Opcionales - ${siteName}`}
        description={`Galería de fotos adicionales de ${siteName}. Más detalles de nuestro salón de eventos.`}
        url="/FotosOpcionales"
      />
